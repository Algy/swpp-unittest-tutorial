...
describe('<Calendar />', () => {
  it('should render without errors', () => {
    const component = shallow(<Calendar year={stubCalendar.year} month={stubCalendar.month} todos={stubCalendar.todos}/>);
  ...
  it('should handle todo clicks', () => {
    ...
    const component = shallow(<Calendar year={stubCalendar.year} 
            month={stubCalendar.month} todos={stubCalendar.todos} clickDone={mockClickDone} />);

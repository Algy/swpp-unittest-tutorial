    ...
    return (
      <div>
        ...
        <div className="header">
          <button className="prev-handler" onClick={this.handleClickPrev}> prev month </button>
          {this.state.year}.{this.state.month}
          <button className="next-handler" onClick={this.handleClickNext}> next month </button>
        </div>
        <Calendar

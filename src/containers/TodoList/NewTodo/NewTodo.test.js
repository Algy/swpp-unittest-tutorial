...
describe("<NewTodo />", () => {
  ...
  it(`should call 'postTodo'`, () => {
    const spyPostTodo = jest.spyOn(actionCreators, "postTodo").mockImplementation((td) => {
      return (dispatch) => {};
    });
    const component = mount(newTodo);
  ...
  it(`should set state properly on title input`, () => {
    ...
    const component = mount(newTodo);
    const wrapper = component.find(".TitleText");
  ...
  it(`should set state properly on content input`, () => {
    ...
    const component = mount(newTodo);
    const wrapper = component.find(".ContentText");
  ...
  it(`should set state properly on year input`, () => {
    const year = "2020";
    const component = mount(newTodo);
    const wrapper = component.find(".YearText");
  ...
  it(`should set state properly on month input`, () => {
    const month = "12";
    const component = mount(newTodo);
    const wrapper = component.find(".MonthText");
  ...
  it(`should set state properly on date input`, () => {
    const date = "12";
    const component = mount(newTodo);
    const wrapper = component.find(".DateText");

...
describe('<NewTodo />', () => {
  ...
  it(`should set state properly on title input`, () => {
    ...
    const component = mount(newTodo);
    const wrapper = component.find('#todoInputTitle');
  ...
  it(`should set state properly on content input`, () => {
    ...
    const component = mount(newTodo);
    const wrapper = component.find('#todoInputContent');
  ...
  it(`should set state properly on year input`, () => {
    const year = '2077';
    const component = mount(newTodo);
    const wrapper = component.find('#todoInputYear');
  ...
  it(`should set state properly on month input`, () => {
    const month = '10';
    const component = mount(newTodo);
    const wrapper = component.find('#todoInputMonth');
  ...
  it(`should set state properly on date input`, () => {
    const date = '19';
    const component = mount(newTodo);
    const wrapper = component.find('#todoInputDate');

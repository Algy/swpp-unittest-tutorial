...
describe('<NewTodo />', () => {
  ...
  it(`should set state properly on Due Date_year input`, () => {
  ...
  it(`should set state properly on Due Date_month input`, () => {
  ...
  it(`should set state properly on Due Date_date input`, () => {
